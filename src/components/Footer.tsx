    ...
    <footer className="border-t border-[var(--color-border)] bg-white">
      <div className="max-w-6xl mx-auto px-6 py-10 text-sm text-[var(--color-text-meta)] flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
        <div>
          ...
          <p className="mt-1 text-xs">Auzouville-sur-Ry (76116) · Télétravail uniquement</p>
        </div>
        <div className="flex flex-wrap gap-5 text-xs">
          ...
          <a href="/mentions-legales" className="hover:text-[var(--color-cyan-dark)] transition-colors">
            Mentions légales
          </a>
        </div>
      </div>
